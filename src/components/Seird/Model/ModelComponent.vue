<template>
  <v-container>
    ...
    <v-row>
      <v-col sm="12" md="9" lg="9" class="p-0">
        <v-card style="margin-top: 8px;padding: 15px">
          ...
          <v-card-text>
            ...
            <p>
              ...
              <br />
              <a
                href="https://m.habr.com/ru/post/500348/"
                target="_blank"
              >Пандемия COVID-19 глазами математика, или почему классическая модель SEIRD не работает</a>
            </p>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col sm="12" md="3" lg="3" style="padding-top: 10px;">
